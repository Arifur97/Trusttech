...
namespace TrustTech\Scaffold\Module;

use Illuminate\Filesystem\Filesystem;
use Illuminate\Support\Facades\Artisan;
use TrustTech\Scaffold\Module\Generators\FilesGenerator;
use TrustTech\Scaffold\Module\Generators\EntityGenerator;
...
class ModuleScaffold
{
     ...
     *
     * @var \TrustTech\Scaffold\Module\Generators\EntityGenerator
     */
     ...
     *
     * @var \TrustTech\Scaffold\Module\Generators\FilesGenerator
     */
     ...
     * @param \TrustTech\Scaffold\Module\Generators\EntityGenerator $entityGenerator
     * @param \TrustTech\Scaffold\Module\Generators\FilesGenerator $filesGenerator
     */
...
JSON;
        ...
        $replace = <<<JSON
"description": "The TrustTech {$moduleName} Module.",
JSON;
...
JSON;
    ...
    private function addDataToComposerJsonFile()
    {
        ...
        foreach (explode(PHP_EOL, $composerJson) as $lineNumber => $textLine) {
            if ($lineNumber === 2) {
                $composerJsonText .= "    \"description\": \"The TrustTech {$moduleName} Module.\"," . PHP_EOL;
