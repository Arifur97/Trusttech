...
Route::middleware('auth')->group(function () {
    ...
    Route::get('account/pc-builder', 'AccountPcBuilderController@index')->name('account.pcbuilder.index');
    Route::get('account/pc-builder/{id}', 'AccountPcBuilderController@show')->name('account.pcbuilder.show');
    Route::get('account/pc-builder/{id}/flag/change', 'AccountPcBuilderController@flagChange')->name('account.pcbuilder.flag.change');
