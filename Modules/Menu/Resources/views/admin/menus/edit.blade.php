...
@section('content')
    <form method="POST" action="{{ route('admin.menus.update', $menu) }}" class="form-horizontal" id="menu-edit-form"
        novalidate>
        {{ csrf_field() }}
        {{ method_field('put') }}
...
@push('globals')
    <script>
        TrustTech.langs['menu::messages.menu_item_deleted'] = '{{ trans('menu::messages.menu_item_deleted') }}';
        TrustTech.langs['menu::messages.menu_items_order_updated'] =
