...
class SettingTabs extends Tabs
{
    ...
    private function homePageSeo()
    {
        return tap(new Tab('home_page_seo', trans('Home Page SEO')), function (Tab $tab) {
            $tab->weight(35);
            $tab->view('setting::admin.settings.tabs.home_page_seo');
        });
    }
