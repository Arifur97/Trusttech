<div class="row">
    <div class="col-md-8">
        ...
        {{ Form::text('offer_message', trans('Discount Message'), $errors, $product) }}
        {{ Form::text('offer_price_start', trans('Offer Price Start'), $errors, $product, ['class' => 'datetime-picker']) }}
        {{ Form::text('offer_price_end', trans('Offer Price End'), $errors, $product, ['class' => 'datetime-picker']) }}
    </div>
</div>
