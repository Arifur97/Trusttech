                            ...
                            <div id="general-information" class="tab-pane fade in active">
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        {{ Form::wysiwyg('description', trans('Description'), $errors, null, ['labelCol' => 3, 'required' => false]) }}
                            ...
                            <div id="seo" class="tab-pane fade">
                                <div class="row">
                                    <div class="col-md-8">
                                        ...
                                        {{ Form::text('meta_title', trans('Meta Title'), $errors) }}
                                        {{ Form::textarea('meta_desc', trans('Meta Description'), $errors) }}
                                        {{ Form::textarea('keyword', trans('Keyword'), $errors) }}
                                        {{ Form::textarea('meta_schema', trans('Schema'), $errors) }}
                                        {{ Form::text('canonical', trans('Canonical'), $errors) }}
                                    </div>
                                </div>
                            </div>
                        </div>
