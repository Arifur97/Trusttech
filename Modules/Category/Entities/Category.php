...
class Category extends Model
{
     ...
     * @var array
     */
    protected $fillable = ['parent_id', 'slug', 'meta_title', 'meta_desc', 'keyword', 'meta_schema', 'canonical', 'description','position', 'is_searchable', 'is_active'];
    ...
    {
        return static::with('files')->where('id', $id)->firstOrNew([]);
    }

    public static function findByIdForTree($id)
    {
