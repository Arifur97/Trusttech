...
TrustTech.dataTable = { routes: {}, selected: {} };
...
export default class {
    constructor(selector, options, callback) {
        ...
        if (TrustTech.dataTable.selected[selector] === undefined) {
            TrustTech.dataTable.selected[selector] = [];
        }
    ...
    appendToSelected(id) {
        ...
        if (!TrustTech.dataTable.selected[this.selector].includes(id)) {
            TrustTech.dataTable.selected[this.selector].push(id);
        }
    }
    ...
    removeFromSelected(id) {
        ...
        TrustTech.dataTable.selected[this.selector].remove(id);
    }
    ...
    route(name, params) {
        let router = TrustTech.dataTable.routes[this.selector][name];
    ...
    hasRoute(name) {
        return TrustTech.dataTable.routes[this.selector][name] !== undefined;
    }

    static setRoutes(selector, routes) {
        TrustTech.dataTable.routes[selector] = routes;
    }

    static setSelectedIds(selector, selected) {
        TrustTech.dataTable.selected[selector] = selected;
    }

    static getSelectedIds(selector) {
        return TrustTech.dataTable.selected[selector];
    }
