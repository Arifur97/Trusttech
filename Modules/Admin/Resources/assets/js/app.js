...
$(function () {
    ...
    var o = $.TrustTech.options;

    // Set up the object
    _init();

    // Activate layout
    $.TrustTech.layout.activate();

    // Enable sidebar tree view controls
    if (o.enableControlTreeView) {
        $.TrustTech.tree('.sidebar');
    }

    // Activate sidebar push menu
    if (o.sidebarPushMenu) {
        $.TrustTech.pushMenu.activate(o.sidebarToggleSelector);
    }
...
/* ----------------------------------
   - Initialize the TrustTech Object -
   ---------------------------------- */
function _init() {
    ...
    $.TrustTech.pushMenu = {
        activate: function (toggleBtn) {
            var screenSizes = $.TrustTech.options.screenSizes;
    ...
    // Tree
    $.TrustTech.tree = function (menu) {
        var animationSpeed = $.TrustTech.options.animationSpeed;
