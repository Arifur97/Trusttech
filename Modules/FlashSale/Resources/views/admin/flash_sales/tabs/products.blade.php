...
@push('globals')
    <script>
        TrustTech.data['flash_sale.products'] = {!! old_json('products', $flashSale->products) !!};
        TrustTech.errors['flash_sale.products'] = @json($errors->get('products.*'), JSON_FORCE_OBJECT);
    </script>
@endpush
