        ...
        <div class="panel-content clearfix">
            ...
            <div class="row">
                <div class="col-lg-6 col-md-12 col-sm-6">
                    ...
                    <div class="checkbox">
                        <input type="hidden" name="{{ $name }}_is_enable" value="0">
                        <input type="checkbox" name="{{ $name }}_is_enable" value="1" id="{{ $name }}-is-enable" {{ $banner->is_enable ? 'checked' : '' }}>
                        <label for="{{ $name }}-is-enable">{{ trans("Enable") }}</label>
                    </div>
                </div>
            </div>
        </div>
