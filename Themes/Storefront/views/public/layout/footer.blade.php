<footer class="footer-wrap mt-5" style="background: #1f294e;">
    <div class="container">
        <div class="footer">
            <div class="footer-top">
                <div class="row">
                    ...
                    @if ($footerMembershipImageOne->exists || $footerMembershipImageTwo->exists)
                        <div class="col-lg-4 col-md-7">
                            <div class="footer-links footer-tags">
                                <h4 class="title">{{ trans('Membership') }}</h4>
                                @if ($footerMembershipImageOne->exists)
                                    <div class="footer-payment mb-2">
                                        <img src="{{ $footerMembershipImageOne->path }}" alt="">
                                    </div>
                                @endif
                                @if ($footerMembershipImageTwo->exists)
                                    <div class="footer-payment">
                                        <img src="{{ $footerMembershipImageTwo->path }}" alt="">
                                    </div>
                                @endif
                            </div>
                        </div>
                    ...
                    @if ($footerCorporateClient->exists)
                        <div class="col-lg-3 col-md-5">
                            <div class="footer-links footer-tags">
                                <h4 class="title">{{ setting('storefront_footer_menu_two_title') }}</h4>
                                <div class="footer-payment">
                                    <img src="{{ $footerCorporateClient->path }}" alt="">
                                </div>
                            </div>
                        </div>
                    @endif
