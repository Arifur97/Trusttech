...
@push('globals')
    <script>
        TrustTech.langs['storefront::account.addresses.confirm'] = '{{ trans('storefront::account.addresses.confirm') }}';
    </script>
@endpush
                    ...
                    <div class="panel-body" v-cloak>
                        <div class="my-addresses">
                            <div class="address-card-wrap" v-if="hasAddress && ! formOpen">
                                <div class="row">
                                    <div class="col-xl-6 col-lg-9 d-flex" v-for="address in addresses"
                                        :key="address.id">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-18">
                                            <div class="form-group">
                                                ...
                                                <input v-model="form.address_1" name="address_1" type="text"
                                                    id="address-1"
                                            ...
                                            <div class="form-group">
                                                <input v-model="form.address_2" name="address_2" type="text"
                                                    id="address-2"
                                        ...
                                        <div class="col-md-9">
                                            <div class="form-group">
                                                ...
                                                <span class="error-message" v-if="errors.has('city')"
                                        ...
                                        <div class="col-md-9">
                                            <div class="form-group">
                                                ...
                                                <span class="error-message" v-if="errors.has('zip')"
