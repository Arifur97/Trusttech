...
class LayoutComposer
{
    ...
    public function compose($view)
    {
        $view->with([
            ...
            'footerMembershipImageOne' => $this->getFooterMembershipImageOne(),
            'footerMembershipImageTwo' => $this->getFooterMembershipImageTwo(),
            'footerCorporateClient' => $this->getFooterCorporateClient(),
    ...
    private function getFooterMembershipImageOne()
    {
        return $this->getMedia(setting('storefront_footer_membership_image_one'));
    }
    
    private function getFooterMembershipImageTwo()
    {
        return $this->getMedia(setting('storefront_footer_membership_image_two'));
    }

    private function getFooterCorporateClient()
    {
        return $this->getMedia(setting('storefront_footer_corporate_client'));
    }
