...
use Themes\Storefront\Http\ViewComposers\LogoComposer;
...
class StorefrontServiceProvider extends ServiceProvider
{
    ...
    public function boot()
    {
        ...
        View::composer(['public.layout', 'public.layout.newsletter_popup'], LayoutComposer::class);
        ...
        View::composer(['public.pcbuilder.index', 'public.pcbuilder.show', 'public.pcbuilder.print'], LogoComposer::class);
