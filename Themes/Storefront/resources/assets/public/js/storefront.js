...
$(() => {
    ...
    _window.on('load scroll resize', () => {
        let headerWrapHeight = headerWrap.outerHeight(),
            headerWrapOffsetTop = headerWrap.offset().top + headerWrapHeight + 20;
        ...
        function stickyHeader() {
            ...
            if (categoryNav.hasClass('thisIsHome')) {
                categoryNav.addClass('show');
            }
        }
    ...
    categoryNav.on({
        mouseenter: function () {
            categoryDropdownWrap.addClass('show');
        },
        // mouseleave: function () {
        //     categoryDropdownWrap.removeClass('show');
        // }
    });
    categoryDropdownWrap.on({
        mouseenter: function () {
            categoryDropdownWrap.addClass('show');
        },
        mouseleave: function () {
    ...
    let BannerTwoColumn = $('.two-column-banner-carousel');

    if (BannerTwoColumn.length !== 0) {
        BannerTwoColumn.slick({
            slidesToShow: 2,
            slidesToScroll: 1,
            autoplay: true,
            autoplaySpeed: 1200,
    ...
    let BannerThreeColumn = $('.three-column-banner-carousel');

    if (BannerThreeColumn.length !== 0) {
        BannerThreeColumn.slick({
            slidesToShow: 3,
            slidesToScroll: 1,
            autoplay: true,
            autoplaySpeed: 1000,
    ...
    let BannerFourColumn = $('.four-column-banner-carousel');

    if (BannerFourColumn.length !== 0) {
        BannerFourColumn.slick({
            slidesToShow: 4,
            slidesToScroll: 1,
            autoplay: true,
            autoplaySpeed: 800,
