...
export default {
    ...
    mounted() {
        ...
        if (this.hasOffer || false) this.fetchOfferProducts();
    ...
    methods: {
        ...
        initPriceFilter() {
            noUiSlider.create(this.$refs.priceRange, {
                connect: true,
                direction: window.TrustTech.rtl ? 'rtl' : 'ltr',
        ...
        fetchProducts(options = { updateAttributeFilters: true }) {
            ...
            $.ajax({
                ...
                this.queryParams.pcbuilder = false;
                this.queryParams.offer = false;
                this.queryParams.offerCategoryId = null;
            });
        },

        fetchPcbuilderProducts() {
            this.queryParams.pcbuilder = true;
            this.fetchProducts();
        },

        fetchOfferProducts($categoryId = null) {
            this.queryParams.offer = true;
            this.queryParams.offerCategoryId = $categoryId;
            this.fetchProducts();
        }
    },
};
