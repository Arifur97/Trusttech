...
class StorefrontTabs extends Tabs
{
    ...
    private function footer()
    {
        return tap(new Tab('footer', trans('storefront::storefront.tabs.footer')), function (Tab $tab) {
            ...
            $tab->view('admin.storefront.tabs.footer', [
                ...
                'footerMembershipImageOne' => $this->getMedia(setting('storefront_footer_membership_image_one')),
                'footerMembershipImageTwo' => $this->getMedia(setting('storefront_footer_membership_image_two')),
                'footerCorporateClient' => $this->getMedia(setting('storefront_footer_corporate_client')),
            ]);
        });
    }
    ...
    {
        return tap(new Tab('product_grid', trans('Home Page Products')), function (Tab $tab) {
            $tab->weight(70);
    ...
    private function offerPageBanner() {
        return tap(new Tab('offer_page_banner', trans('Offer Page Banner')), function (Tab $tab) {
            $tab->weight(85);
            $tab->view('admin.storefront.tabs.offer_page_banner', [
