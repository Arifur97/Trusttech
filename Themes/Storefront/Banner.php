...
class Banner
{
    ...
    public function __construct($image, $call_to_action_url, $open_in_new_window, $is_enable)
    {
        $this->image = $image;
        $this->call_to_action_url = $call_to_action_url;
        $this->open_in_new_window = (bool) $open_in_new_window;
        $this->is_enable = (bool) $is_enable;
    }
    ...
    public static function getOfferPageBanner()
    {
        return self::findByName('storefront_offer_page_banner');
    }
